...
class FormServiceInputWidget extends StatefulWidget {
  const FormServiceInputWidget({super.key, required this.orderType});

  final OrderType? orderType;

  @override
  State<FormServiceInputWidget> createState() => _FormServiceInputWidgetState();
}

class _FormServiceInputWidgetState extends State<FormServiceInputWidget> {
  ...
  @override
  void initState() {
    servicesCubit = context.read<ServicesCubit>();
